...
exports.BlocksTraceService = void 0;
 ...
 */
const DEFAULT_KEYS = '3a65787472696e7369635f696e646578,26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da9';
class BlocksTraceService extends AbstractService_1.AbstractService {
    /**
     ...
     */
    async operations(hash, historicApi, includeActions) {
        ...
        if (traceResponse.isTraceError) {
            ...
            const trace = new trace_1.Trace(this.api, BlocksTraceService.formatBlockTrace(traceResponse.asBlockTrace), historicApi.registry);
     ...
     */
    static formatBlockTrace(blockTrace) {
...
exports.BlocksTraceService = BlocksTraceService;
