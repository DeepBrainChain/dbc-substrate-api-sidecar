...
const validateService = new AccountsValidateService_1.AccountsValidateService(mockApi);
describe('Validate addresses', () => {
    it('Should verify a polkadot address', () => {
        ...
        expect((0, sanitize_1.sanitizeNumbers)(validateService.validateAddress(polkadotAddr))).toStrictEqual(expectedResponse);
    });
    it('Should verify a kusama address', () => {
        ...
        expect((0, sanitize_1.sanitizeNumbers)(validateService.validateAddress(kusamaAddr))).toStrictEqual(expectedResponse);
    });
    it('Should verify a kulupu address', () => {
        ...
        expect((0, sanitize_1.sanitizeNumbers)(validateService.validateAddress(kulupuAddr))).toStrictEqual(expectedResponse);
    });
    it('Should verify a valid default substrate address', () => {
        ...
        expect((0, sanitize_1.sanitizeNumbers)(validateService.validateAddress(substrateAddr))).toStrictEqual(expectedResponse);
    });
    it('Should give the correct response for a polkadot hex value', () => {
        ...
        expect((0, sanitize_1.sanitizeNumbers)(validateService.validateAddress(polkadotHex))).toStrictEqual(expectedResponse);
    });
    it('Should give the correct response for a kusama hex value', () => {
        ...
        expect((0, sanitize_1.sanitizeNumbers)(validateService.validateAddress(kusamaHex))).toStrictEqual(expectedResponse);
    });
    it('Should give the correct response for a karura hex value', () => {
        ...
        expect((0, sanitize_1.sanitizeNumbers)(validateService.validateAddress(karuraHex))).toStrictEqual(expectedResponse);
    });
    it('Should return the correct response for an invalid hex value', () => {
        ...
        expect((0, sanitize_1.sanitizeNumbers)(validateService.validateAddress(invalidAddr))).toStrictEqual(expectedResponse);
    });
    it('Should correctly throw an error for an invalid ss58 address', () => {
        ...
        expect(() => (0, sanitize_1.sanitizeNumbers)(validateService.validateAddress(invalidAddr))).toThrow('Error: Invalid base58 character "0" (0x30) at index 48');
    });
});
//# sourceMappingURL=AccountsValidateService.spec.js.map