...
exports.ContractsInkService = void 0;
const AbstractService_1 = require("../AbstractService");
class ContractsInkService extends AbstractService_1.AbstractService {
    /**
     ...
     */
    async fetchContractCall(contract, address, method, args, gasLimit, storageDepositLimit) {
        const options = {
            gasLimit: gasLimit || -1,
            storageDepositLimit: storageDepositLimit || null,
        };
        const callResult = args && args.length > 0
...
exports.ContractsInkService = ContractsInkService;
