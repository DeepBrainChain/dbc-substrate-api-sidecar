 ...
 */
class PalletsAssetsController extends AbstractController_1.default {
    constructor(api) {
        super(api, '/pallets/assets/:assetId', new services_1.PalletsAssetsService(api));
        this.getAssetById = async ({ params: { assetId }, query: { at } }, res) => {
